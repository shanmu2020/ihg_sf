...
<div class="container" >
	<div class="row">
	   ...
	   <div class="col-md-3 ">
	   <div class="btn-group">
	   <?php if(($table != 'position')): ?><button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<button id="addtoday" class="btn btn-warning">今日菜品发布</button><br><br>
<?php echo ($page); ?>
</div>
<script src="/IHG/Public/Js/common.js"></script>
<script>
