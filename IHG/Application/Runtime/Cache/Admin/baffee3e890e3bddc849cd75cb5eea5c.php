...
<a class="navbar-brand" href="/IHG/index.php">前端首页</a></div>
            <ul class="nav navbar-nav nav-tabs ">
            <li class="active"><a href="/IHG/admin.php"><strong>文章管理</strong></a></li>
            <li><a></a></li>
            <li class="dropdown">
            <a class="btn" data-toggle="dropdown"><span class="glyphicon glyphicon-user">用户名</span></a>
            <ul class="dropdown-menu">
                       <li><a><span class="glyphicon glyphicon-off">退出</span></a></li>
		   ...
		   <br><br><br><br>
<form class="form-horizontal" action="/IHG/admin.php?m=admin&c=editor&a=insert" method="post" enctype="multipart/form-data" name="file">
...
<select class="form-control" name="category">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-5">
      <input id="file_upload"  type="file" multiple="true" name="myfile" >
